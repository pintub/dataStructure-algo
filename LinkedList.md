...
- Reverse LL questions
  - Reverse LL
    ...
    - Recursive, Same approach as above, Leads to tail recursion using Type-2 recursion with both prevNode and currNode as params. Note: Type-1 recursion here leads to non-tail recusrion
