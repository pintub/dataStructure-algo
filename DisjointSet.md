...
- ArrayMap is used, Index => Element, Value => Set-Name
  ...
  - :bulb: Alternatively, <u>`ArrayMap can be replaced by HashMap<node, parentNode>`</u>. It's useful in-case of String or Character Question. [Example merge Person's email Ids](./Leetcode/src/main/java/year2k21/common/pattern/unionfind/date15022023/AccountsMerge721.java)
